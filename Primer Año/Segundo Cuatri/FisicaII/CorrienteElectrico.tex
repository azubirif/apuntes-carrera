...
\[
	...
	= \varepsilon \frac{S}{l}
\]
\subsection{Energía electroestática almacenada}
Anteriormente vimos que la energía electroestática de una esfera cargada era
\[
	U = \frac{1}{2}CV^{2}
\]
Cuando sustituimos la capacidad, obtenemos
\[
	U = \frac{1}{2} \varepsilon \frac{S}{l} (EL)^{2} = \frac{1}{2}\varepsilon SlE^{2}
\]
Por otra parte, sabiendo que \(Vol = Sl\), tenemos
\[
	U = \frac{1}{2}\varepsilon Vol\cdot E^{2}
\]
\subsection{Densidad de energía electroestática}
Denotada como \(u\), es
\begin{equation}
	\begin{split}
		u = \dv{U}{(Vol)} = \frac{U}{Vol} = \frac{1}{2}\varepsilon E^{2}
	\end{split}
\end{equation}
\end{document}
